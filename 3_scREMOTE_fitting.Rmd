...
A <- readRDS(file.path(datadir, "A_further_filtered_04-11-2020.rds"))
H <- readRDS(file.path(datadir, "H_further_filtered_04-11-2020.rds"))
E <- readRDS(file.path(datadir, "E_further_filtered_04-11-2020.rds"))
C <- readRDS(file.path(datadir, "C_further_filtered_04-11-2020.rds"))
T_mat <- readRDS(file.path(datadir, "T_further_filtered_04-11-2020.rds"))
cell_types <- readRDS("Processed_matrices/celltypes_processed_30-10-20.rds")
R <- readRDS(file.path(datadir, "B_full_24-11-2020.rds"))
```
